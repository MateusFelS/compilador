...
public sealed class SyntaxTree{
    ...
    public static ImmutableArray<SyntaxToken> ParseTokens(string text, out ImmutableArray<Diagnostics> diagnostics){
        var sourceText = SourceText.From(text);
    ...
    public static ImmutableArray<SyntaxToken> ParseTokens(SourceText text, out ImmutableArray<Diagnostics> diagnostics){
